...
<div id="wrapper">
     		<div id="form-maina">
              <div id="form-diva">
		 <span class="titulo"><div align="center">Política de privacidad</div></span>
			<br/><br/>
        Si usted requiere más información o tiene alguna pregunta sobre nuestra política de privacidad, no dude en contactar con nosotros por correo electrónico a info@chapachapa.com.pe
        <br/><br/>
        En www.chapachapa.com.pe, la privacidad de nuestros visitantes es de extrema importancia para nosotros. Este documento de política de privacidad describe los tipos de información personal que se reciba y recogidos por www.geeksupremo.com y cómo se utiliza.
        <br/><br/>
        Archivos de registro<br/>
        Al igual que muchos otros sitios Web, www.chapachapa.com.pe hace uso de archivos de registro. La información contenida en esos archivos incluye direcciones de protocolo de Internet (IP), tipo de navegador, proveedor de servicios de Internet (ISP), sello de fecha / hora, páginas de referencia / salida, y el número de clics para analizar tendencias, administrar el sitio, rastrear el movimiento del usuario alrededor del sitio, y recopilar información demográfica. direcciones IP y otra información que no están vinculados a ninguna información que sea personalmente identificable.
      </div>
    </div>
    <div id="footer">
        <div class="left">
