...
<?php include"include/menu.php";?>
		...
		<div id="wrapper">
     		<div id="form-maina">
              <div id="form-diva">
      <span class="titulo"><div align="center">Términos y Condiciones</div></span>
		<br/><br/>
		A continuación se presentan los términos y condiciones de uso de www.geeksupremo.com. Por favor, lea detenidamente. Si necesita ponerse en contacto con nosotros en relación con cualquier aspecto de las siguientes condiciones de uso de nuestra página web, por favor, póngase en contacto con nosotros en la siguiente dirección de correo electrónico – info@chapachapa.com.pe
      <br/><br/>
      Al acceder al contenido de www.chapachapa.com.pe (en adelante, el Portal) que acepta los términos y condiciones establecidos en este documento y también acepta nuestra Política de privacidad. Si no está de acuerdo con cualquiera de los términos y condiciones, no debe continuar utilizando el sitio web y salir inmediatamente.
<br/><br/>
El usuario acepta que no usará el sitio Web para fines ilegales, y que va a respetar todas las leyes y regulaciones aplicables.
      </div>
    </div>
